...
def main():
    parser = argparse.ArgumentParser(
        description="LogJam - A configurable tool for filtering text files"
    )
    parser.add_argument(
        "file", nargs="?", help="Path to the log file to open (positional)"
    )
    parser.add_argument(
        "--file",
        "-i",
        dest="file_flag",
        help="Path to the log file to open (optional flag)",
    )
